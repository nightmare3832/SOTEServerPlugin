...
public class PaintBallLauncherLobbyItem extends LobbyItem{

    public PaintBallLauncherLobbyItem(){
    }
    ...
    public void shot(Player player){
        ...
        Server.getInstance().getScheduler().scheduleDelayedTask(new CallbackPaint(this,player,MX,MY,MZ,0,pos,eid,player.getLevel()),1);
    }
    ...
    public void shot2(Player player,double MX,double MY,double MZ,int i,Vector3 pos,Long eid,Level level){
        ...
        Server.getInstance().getScheduler().scheduleDelayedTask(new CallbackPaint(this,player,MX,MY,MZ,i,pos,eid,level),1);
    }
...
class CallbackPaint extends Task{

    public PaintBallLauncherLobbyItem owner;
    ...
    public CallbackPaint(PaintBallLauncherLobbyItem o,Player player,double MX,double MY,double MZ,int i,Vector3 pos,Long eid,Level l){
        this.owner = o;
        this.player = player;
        this.mx = MX;
        this.my = MY;
