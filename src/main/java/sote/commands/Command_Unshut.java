...
public class Command_Unshut extends Command{

    public Command_Unshut(Main plugin){
        super("unshut");
    ...
    public static void shut(Player player,String data){
        ...
        if(target instanceof Player){
            Ban.setChatBan(target,false);
            player.sendMessage("§f[§dSOTE§f] §a"+data+"をunshutしました");
        }else{
