...
public class GameSelectChestInventory extends ServerChestInventory{
    ...
    public GameSelectChestInventory(Player player){
        super(player);
    }
    ...
    public void register(){
        ...
        //this.windowid = cnt;
        Server.getInstance().getScheduler().scheduleDelayedTask(new CallbackOpenGameSelectChestInventory(this), 5);
    }
...
class CallbackOpenGameSelectChestInventory extends Task{

    public GameSelectChestInventory owner;

    public CallbackOpenGameSelectChestInventory(GameSelectChestInventory o){
        owner = o;
    }
